...
{ code: 91202, message: "Origin/To station not operational or unavailable" },
{
code: 91203,
...
{ code: 91206, message: "Service temporarily unavailable from seller side" },
{ code: 91207, message: "Payment transaction failed" },
{ code: 91208, message: "Ticketing not allowed during un-operational hours" },
{ code: 91209, message: "Unable to retrieve ticket details" },
{ code: 91210, message: "Unable to retrieve station list and data" },
{ code: 91211, message: "Cannot fetch fare details for the selected route" },
